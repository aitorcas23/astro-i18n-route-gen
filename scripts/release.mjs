...
const main = async () => {
	...
	await run(
		`gh release create ${tag} --title ${tag} --notes "Please refer to [CHANGELOG.md](https://github.com/aitorcas23/astro-i18n-routes/blob/main/package/CHANGELOG.md) for details."`
	);
};
